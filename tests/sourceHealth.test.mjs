...
assert.deepEqual(health.stages.map(stage => stage.id), ['search', 'bookInfo', 'toc', 'content', 'shelf'])
...
assert.equal(healthyDiagnostics.health.score, 100)
assert.equal(healthyDiagnostics.health.stageCount, 5)
