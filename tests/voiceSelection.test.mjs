...
assert.match(voicePage, /萝莉/)
assert.match(voicePage, /大叔/)
assert.match(voicePage, /青年/)
assert.match(voicePage, /正太/)
assert.match(voicePage, /朗诵/)
assert.match(voicePage, /即将支持/)
