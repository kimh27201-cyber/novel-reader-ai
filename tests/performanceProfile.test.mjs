...
assert.equal(getPerformanceProfile({ platform: 'android', navigatorRef: {}, mode: 'auto' }).tier, 'lite')
assert.equal(getPerformanceProfile({ platform: 'android', navigatorRef: {}, mode: 'full' }).tier, 'full')
